module ArgoPump::router {
    ...
    use ArgoPump::position::{authorized_borrow, mint_position, burn_position};
    use ArgoPump::hook_factory::{Tx, hook_type};
    use ArgoPump::hook_factory;
    use ArgoPump::position;
    ...
    public fun init_module_for_test() {
        init_module(&create_signer_for_test(@ArgoPump));
